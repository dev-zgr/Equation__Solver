...
# forbidden chararachters in equation input
forbidden_character = {"Q", "q" ,"W", "w" ,"e" ,"E" ,"R" ,"r" , "t", "T" , "y" ,"Y" ,"U" ,"u" ,"I" "i" ,"O" ,"o" ,\
"P" ,"p" ,"a" ,"A" ,"D" ,"d" ,"f" ,"F" ,"G" , "g" ,"H" ,"h" ,"J", "j" ,"k" , "K" ,"L" ,"l" , "Z" ,"z" ,"c" ,"v" ,"b",  \
"n" ,"m" , "C", "V",  "B" , "N" "M" , "!" ,"'", '"' ,"^" ,"%" ,"&", "/", "(" ,")" ,"?"}
...
def checker(equation):
    """This functions checks if input is a valid equation and respect to x"""
    ...
    # Calculates the every individual term
